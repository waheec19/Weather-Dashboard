...
// This function runs the Open Weather API and displays the current city, weather, and 5 day forecast to the DOM
async function displayWeather() {
    ...
    var response = await $.ajax({
        ...
        // get UV Index info and setting color class according to value
